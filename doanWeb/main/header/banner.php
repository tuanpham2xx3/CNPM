                    ...
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="#"><img src="images/banner/slideshow_1.jpg" class="img-fluid"
                                        style="height: 500px;" width="1200px" alt="First slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="images/banner/slideshow_2.jpg" class="img-fluid"
                                        style="height: 500px;" width="1200px" alt="Second slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="images/banner/slideshow_3.jpg" class="img-fluid"
                                        style="height: 500px;"  width="1200px"  alt="Third slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="images/banner/slideshow_6.jpg" class="img-fluid"
                                        style="height: 500px;"  width="1200px"  alt="Third slide"></a>
                            </div>
                        </div>
