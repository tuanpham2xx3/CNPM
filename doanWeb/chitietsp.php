            ...
            <div class="product-detail bg-white p-4">
                <div class="row">
                    ...
                    <div class="col-md-5 khoianh">
                        ...
                        { 
                            ?>
                            <img class="product-image" src="<?php echo $value[2]; ?> " class="img-fluid" data-fancybox="thumb-img">
                            <?php
                        }
                            ?>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <form method="GET" action="cart.php">
                                ...
                                <div class="uudai my-3">
                                    <h6 class="header font-weight-bold">Khuyến mãi & Ưu đãi tại Balo TT:</h6>
                                    <ul>
                                        ...
                                        <li>♦ Phụ kiện du lịch chính hãng</li>

                                        <li>♦ Voucher giảm giá lến đến 1.290.000đ</li>
                                ...
                                <?php if($product['quatity'] > 0) {?>
                                    <div class="soluong d-flex"><label class="font-weight-bold">Tồn Kho: <?=$product['quatity']?></label></div>
                                <form>
                                    <?php
                                ...
                                <?php } else { ?>
                                    <span class="erorr" style="color:#FF0000; font-weight: bold;">Hết hàng</span>
                                    <?php } ?>
                            ...
                            <div class="col-md-5">
                                <div class="thongtinsach">
                                    <ul>
                                        <li> <span class="header font-weight-bold">Khi mua tại Balo TT quý khác sẽ được:</span></li>
                                        <li><b>Miễn phí giao hàng </b>cho đơn hàng từ 150.000đ ở TP.Đà Nẵng và 300.000đ ở
                                            Tỉnh/Thành khác</li>
                                        <li>Tặng sản phẩm kèm theo cho mỗi đơn hàng</li>
                                        <li>Kiểm tra hàng trước khi nhận(nếu đăng kí)</li>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="formdanhgia">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="name" class="txtFullname w-100" placeholder="Nhập tên của bạn">
                                                <div class="has-error">
                                                    <span>
